    ...
    <>
      <div className="flex justify-between items-center my-10">
        <div>
          ...
          <span className="text-xl text-purple-400 phonetic">{phonetic}</span>
        </div>
      ...
      <div className="flex gap-5 items-center mx-3">
        <span className="text-slate-900 font-semibold text-xl">noun</span>
      ...
      <div className="flex gap-5 items-center mx-3">
        <span className="text-slate-900 font-semibold text-xl">Verb</span>
        <hr className="border border-neutral-200 w-11/12" />
      </div>
      ...
      <div className="flex gap-x-5 my-10 flex-wrap">
        ...
        <a
          ...
          target="_blank"
          className="text-neutral-700 underline h-fit"
        >
          {source && source[0]}
        </a>
      </div>
